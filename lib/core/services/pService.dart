...
var productRawData = [
  {
    ...
    'reviews': [
      {
        'photo_url': 'aset/images/avatar1.jpg',
        'name': 'Uchiha Sasuke',
      ...
      {
        'photo_url': 'aset/images/avatar2.jpg',
        'name': 'Uzumaki Naruto',
        'review': 'Bringing a new look to the Waffle sneaker family, the Nike Waffle One balances everything you love about heritage Nike running with fresh innovations.',
        'rating': 4.0,
      },
      {
        'photo_url': 'aset/images/avatar3.jpg',
